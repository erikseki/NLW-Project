...
// // Mock do db
// vi.mock('../src/repositories/subscriptionRepository', () => ({
//   SubscriptionRepository: {
//     findByEmail: vi.fn(() => Promise.resolve([{ id: '1' }])),
//     createSubscriber: vi.fn(() => Promise.resolve([{ id: '2' }])),
//   },
// }))
...
//       'erik@email.com'
//     ) // Verifica se a função select foi chamada
//   })
...
//     vi.spyOn(SubscriptionRepository, 'findByEmail').mockResolvedValueOnce([])
...
//     expect(result).toEqual({ subscriberId: '2' }) // Espera o ID '2' que vem do mock de insert
//     expect(SubscriptionRepository.createSubscriber).toHaveBeenCalledWith({
//       name: 'Novo Usuário',
//       email: 'novo@email.com',
//     }) // Verifica se a função insert foi chamada
